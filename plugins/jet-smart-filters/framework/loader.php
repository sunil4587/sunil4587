 ...
 * 2. Add unique prefix for the class name, e.g. - Twentyseventeen_Jet_Smart_Filters_CX_Loader
 ...
 *     new Twentyseventeen_Jet_Smart_Filters_CX_Loader(
 *         array(
...
if ( ! class_exists( 'Jet_Smart_Filters_CX_Loader' ) ) {

	/**
	 * Define Jet_Smart_Filters_CX_Loader class
	 */
	class Jet_Smart_Filters_CX_Loader {
