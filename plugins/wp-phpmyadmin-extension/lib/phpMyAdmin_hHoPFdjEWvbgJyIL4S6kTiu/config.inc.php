...
$cfg['blowfish_secret']					= 'eCd1hID}$bJJ)TpHDnHU.7do:G1=L6U=' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_hHoPFdjEWvbgJyIL4S6kTiu/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
