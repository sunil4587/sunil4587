 ...
 * @since 1.0
 */
class XT_Woo_Points_Rewards_Legacy_Discount {
	...
	public function __construct( &$core ) {
		...
		$core->plugin_loader()->add_filter( 'woocommerce_get_shop_coupon_data', $this, 'get_discount_data' , 10, 2 );

		// filter the "coupon applied successfully" message
		$core->plugin_loader()->add_filter( 'woocommerce_coupon_message', $this, 'get_discount_applied_message' , 10, 3 );

		// Set the discount amount when needed
		$core->plugin_loader()->add_filter( 'woocommerce_coupon_get_discount_amount', $this, 'get_discount_amount' , 10, 5 );
	}
	...
	public function get_discount_amount( $discount, $discounting_amount, $cart_item, $single, $coupon ) {
		...
		$total_discount = XT_Woo_Points_Rewards_Cart_Checkout::get_discount_for_redeeming_points( true );
