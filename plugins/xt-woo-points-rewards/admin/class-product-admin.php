 ...
 * @since 1.0
 */
class XT_Woo_Points_Rewards_Product_Admin
{
    /**
    ...
    public function __construct( &$core )
    {
        ...
        $core->plugin_loader()->add_action( 'woocommerce_product_options_general_product_data', $this, 'render_simple_product_fields' );
        /** Variable Product hooks */
        // add 'Points Earned' to variable products under the 'Variations' tab after the shipping class dropdown
        $core->plugin_loader()->add_action(
            'woocommerce_product_after_variable_attributes',
            $this,
            'render_variable_product_fields',
            15,
            3
        );
        /** Product category hooks */
        // add 'Points Earned' field to the add product category page
        $core->plugin_loader()->add_action( 'product_cat_add_form_fields', $this, 'render_product_category_fields' );
        // add 'Points Earned' field to view/edit product category
        $core->plugin_loader()->add_action( 'product_cat_edit_form_fields', $this, 'render_edit_product_category_fields' );
    }
    ...
    public function render_simple_product_fields()
    {
        ...
        do_action( 'xt_woopr_after_product_fields' );
    }
