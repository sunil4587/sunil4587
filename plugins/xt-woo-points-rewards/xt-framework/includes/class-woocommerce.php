    ...
    class XT_Framework_Woocommerce {
        ...
        public static function wrap_product_images() {
            ...
            // Other themes
                ...
                add_action('woocommerce_before_shop_loop_item_title', array(__CLASS__, 'template_loop_before_product_thumbnail'), 9.9);
                add_action('woocommerce_before_shop_loop_item_title', array(__CLASS__, 'template_loop_after_product_thumbnail'), 10.1);
            }
